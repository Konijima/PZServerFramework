...
*   **Lifecycle Events:** Standardized events (`OnNetworkAvailable`, `OnPlayerInit`, `OnRemotePlayerInit`, etc.) that solve common MP/SP timing issues.
...
2.  Ensure `KoniLib` is enabled whenever using `AreaSystem` or other dependent mods.
